...
public class OnvifFinder {
    ...
    private static final String ONVIF_FINDER_CONTENT2 =
            "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                    "\n" +
                    "<Envelope xmlns=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:dn=\"http://www.onvif.org/ver10/network/wsdl\">\n" +
                    "  <Header>\n" +
                    "    <wsa:MessageID xmlns:wsa=\"http://schemas.xmlsoap.org/ws/2004/08/addressing\">uuid:9c9cc10f-2035-4049-93b9-7b3aa2ef4f42</wsa:MessageID>\n" +
                    "    <wsa:To xmlns:wsa=\"http://schemas.xmlsoap.org/ws/2004/08/addressing\">urn:schemas-xmlsoap-org:ws:2005:04:discovery</wsa:To>\n" +
                    "    <wsa:Action xmlns:wsa=\"http://schemas.xmlsoap.org/ws/2004/08/addressing\">http://schemas.xmlsoap.org/ws/2005/04/discovery/Probe</wsa:Action>\n" +
                    "  </Header>\n" +
                    "  <Body>\n" +
    ...
    public OnvifFinder(long timeoutMillis) {
        this(DEFAULT_TARGET, Integer.MAX_VALUE, timeoutMillis);
    }
    ...
    private List<OnvifDiscoverer> doFind(List<OnvifDiscoverer> discovererList,
        ...
        Set<OnvifDiscoverer> set = new TreeSet<>(new Comparator<OnvifDiscoverer>() {
            @Override
            public int compare(OnvifDiscoverer o1, OnvifDiscoverer o2) {
                String host1 = o1.getHost();
                return host1.equals(o2.getHost()) ? 0 : host1.compareTo(o2.getHost());
            }
        });
        ...
        try {
            ...
            datagramChannel.send(
                    ByteBuffer.wrap(ONVIF_FINDER_CONTENT2.getBytes()),
                    new InetSocketAddress(target, DEFAULT_FINDER_PORT));
            read:
            ...
            onvifDiscovererList.addAll(set);
            if (finderCallback != null) {
